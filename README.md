...
[![OpenNDX](https://img.shields.io/badge/OpenNDX-Reference%20Implementation-green.svg)](https://openndx.org)

The **National Data Exchange (NDX)** is a reference implementation for the fictional country of Farajaland. NDX demonstrates secure, privacy-preserving data exchange across government agencies through a citizen-centric, consent-based approach.
